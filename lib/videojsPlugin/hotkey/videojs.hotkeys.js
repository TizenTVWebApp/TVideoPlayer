        ...
        if (alwaysCaptureHotkeys ||
          ...
          switch (checkKeys(event, player)) {
            ...
            case cLeft: // Seek Forward
                ...
                console.log(seekBar);
                console.log(seekTimeBar);
                console.log(isMoving);
                if(isMoving){
                	seekMoveTime = seekMoveTime-10;                	
                }else{
                	seekMoveTime = player.currentTime() - 10;
                }
                    isMoving = true;
                    console.log(seekMoveTime);
                    console.log(player.duration);
                	var percent = seekMoveTime/player.duration();
                	console.log(progressControl);
                	//progressControl.el_.focus();
                	//seekTimeBar.focus();
                	//seekBar.focus();
                	//seekBar.el_.addClass('hover');
                	//progressControl.handleMouseMove({pageX:369,pageY:777});
               // progressControl.handleSeekMove(percent);
                //seekTimeBar.el_.show();
                //seekBar.enable();
                seekBar.stepForward();
                break;
            case cRight: // Seek Forward
                ...
                if(isMoving){
                	...
                	seekMoveTime = player.currentTime() + seekStep;
                }
                    isMoving = true;
                    var percent = seekMoveTime/player.duration();
                    //progressControl.focus();
                  //  progressControl.handleMouseMove({pageX:345,pageY:777});
               // progressControl.handleSeekMove(percent);
                //seekBar.enable();
                seekBar.stepForward();
                break;
